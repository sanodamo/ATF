...
public class DatabasePropertiesHelper extends ConfigPropertiesHelper {
	private String propFile;
	private Properties dbPropFile;
	private static Logger log = Logger.getLogger(DatabasePropertiesHelper.class.getName());
	public DatabasePropertiesHelper(String propFile) {
